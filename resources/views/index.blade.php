...
@font-face {
  ...
  font-display: swap;
  src: local(''),
       url('{{ asset('assets/fonts/inter-v12-latin-500.woff2') }}') format('woff2'), /* Chrome 26+, Opera 23+, Firefox 39+ */
       url('{{ asset('assets/fonts/inter-v12-latin-500.woff') }}') format('woff'); /* Chrome 6+, Firefox 3.6+, IE 9+, Safari 5.1+ */
}
@font-face {
  font-family: 'Inter';
  font-style: normal;
  ...
  font-display: swap;
  src: local(''),
       url('{{ asset('assets/fonts/inter-v12-latin-700.woff2') }}') format('woff2'), /* Chrome 26+, Opera 23+, Firefox 39+ */
       url('{{ asset('assets/fonts/inter-v12-latin-700.woff') }}') format('woff'); /* Chrome 6+, Firefox 3.6+, IE 9+, Safari 5.1+ */
}
{{ asset('assets/') }}
</style>
  ...
  <span class="ms-md-1 mt-1 fw-bolder me-md-5">Klar</span>
      ...
      <li class="nav-item">
  <a class="nav-link fs-5" href="{{ route('index.content') }}" aria-label="Homepage">
    Home
  </a>
</li>
<li class="nav-item">
  {{-- <a class="nav-link fs-5" href="content.html" aria-label="A sample content page"> --}}
    <a class="nav-link fs-5" href="{{ route('content.index') }}" aria-label="A sample content page">
...
<li class="nav-item">
  {{-- <a class="nav-link fs-5" href="{{ url('system')}}" aria-label="A system message page"> --}}
    <a class="nav-link fs-5" href="{{ route('system.index') }}" aria-label="A system message page">
    System
  </a>
</li>
  ...
  <div class="container-fluid px-vw-5">
    ...
    <div class="row d-flex align-items-center position-relative justify-content-center px-0 g-5">
      <div class="col-12 col-lg-6">
        <img src="{{ asset('assets/img/webp/abstract18.webp') }}" width="2280" height="1732" alt="abstract image" class="img-fluid position-relative rounded-5 shadow" data-aos="fade-up">
      </div>
      <div class="col-12 col-md-6 col-lg-3">
        <img src="{{ asset('assets/img/webp/abstract6.webp') }}" width="1116" height="1578" alt="abstract image" class="img-fluid position-relative rounded-5 shadow" data-aos="fade-up" data-aos-duration="2000">
      </div>
      <div class="col-12 col-md-6 col-lg-3">
        <img src="{{ asset('assets/img/webp/abstract9.webp') }}" width="1116" height="848" alt="abstract image" class="img-fluid position-relative rounded-5 shadow" data-aos="fade-up" data-aos-duration="3000">
      </div>
    </div>
  </div>
</div>
  ...
  <div class="row gx-5">
    <div class="col-12 col-md-6">
      <div class="card bg-transparent mb-5" data-aos="zoom-in-up">
        <div class="bg-dark shadow rounded-5 p-0">
          <img src="{{ asset('assets/img/webp/abstract3.webp') }}" width="582" height="327" alt="abstract image" class="img-fluid rounded-5 no-bottom-radius" loading="lazy">
          <div class="p-5">
      ...
      <div class="card bg-transparent" data-aos="zoom-in-up">
        <div class="bg-dark shadow rounded-5 p-0">
          <img src="{{ asset('assets/img/webp/abstract2.webp') }}" width="582" height="442" alt="abstract image" class="img-fluid rounded-5 no-bottom-radius" loading="lazy">
          <div class="p-5">
            <h2 class="fw-lighter">Ipsum dolor est</h2>
            <p class="pb-4 text-secondary">Lorem ipsum dolor sit amet, consetetur sadipscing elitr, sed diam nonumy eirmod tempor invidunt ut labore et dolore magna aliquyam erat.</p>
            <a href="#" class="link-fancy link-fancy-light">Read more</a>
    ...
    <div class="col-12 col-md-6">
      ...
      <div class="card bg-transparent mb-5 mt-5" data-aos="zoom-in-up">
        <div class="bg-dark shadow rounded-5 p-0">
          <img src="{{ asset('assets/img/webp/abstract17.webp') }}" width="582" height="390" alt="abstract image" class="img-fluid rounded-5 no-bottom-radius" loading="lazy">
          <div class="p-5">
            <h2 class="fw-lighter">Ipsum dolor est</h2>
            <p class="pb-4 text-secondary">Lorem ipsum dolor sit amet, consetetur sadipscing elitr, sed diam nonumy eirmod tempor invidunt ut labore et dolore magna aliquyam erat.</p>
            <a href="#" class="link-fancy link-fancy-light">Read more</a>
      ...
      <div class="card bg-transparent" data-aos="zoom-in-up">
        <div class="bg-dark shadow rounded-5 p-0">
          <img src="{{ asset('assets/img/webp/abstract4.webp') }}" width="582" height="327" alt="abstract image" class="img-fluid rounded-5 no-bottom-radius" loading="lazy">
          <div class="p-5">
            <h2 class="fw-lighter">Ipsum dolor est</h2>
            <p class="pb-4 text-secondary">Lorem ipsum dolor sit amet, consetetur sadipscing elitr, sed diam nonumy eirmod tempor invidunt ut labore et dolore magna aliquyam erat.</p>
            <a href="#" class="link-fancy link-fancy-light">Read more</a>
  ...
  <div class="container px-vw-5 py-vh-5">
    <div class="row d-flex align-items-center">
      ...
      <div class="col-12 col-lg-7">
        <img class="img-fluid rounded-5 mb-n5 shadow" src="{{ asset('assets/img/webp/person9.webp') }}" width="512" height="512" alt="a nice person" loading="lazy" data-aos="zoom-in-right">
        <img class="img-fluid rounded-5 ms-5 mb-n5 shadow" src="{{ asset('assets/img/webp/person11.webp') }}" width="512" height="512" alt="another nice person" loading="lazy" data-aos="zoom-in-up">
      </div>
...
<div class="position-relative py-vh-5 bg-cover bg-center rounded-5" style="background-image: url({{ asset('assets/img/webp/abstract12.webp') }})">
  <div class="container bg-black px-vw-5 py-vh-3 rounded-5 shadow">
  <div class="row d-flex align-items-center">
  ...
  <div class="col-6 d-flex align-items-center bg-dark shadow rounded-5 p-0" data-aos="zoom-in-up">
    <div class="row d-flex justify-content-center">
      <div class="col-12">
    <img src="{{ asset('assets/img/webp/person103.webp') }}" width="684" height="457" alt="our CEO with some nice numbers" class="img-fluid rounded-5" loading="lazy">
  </div>
...
<div class="container px-vw-5">
  ...
  <path d="M3.612 15.443c-.386.198-.824-.149-.746-.592l.83-4.73L.173 6.765c-.329-.314-.158-.888.283-.95l4.898-.696L7.538.792c.197-.39.73-.39.927 0l2.184 4.327 4.898.696c.441.062.612.636.282.95l-3.522 3.356.83 4.73c.078.443-.36.79-.746.592L8 13.187l-4.389 2.256z"/>
        ...
        <div class="d-flex justify-content-start align-items-center border-top border-secondary pt-3">
          <img src="{{ asset('assets/img/webp/person14.webp') }}" width="96" height="96" class="rounded-circle me-3" alt="a nice person" data-aos="fade" loading="lazy">
          <div>
  ...
  <path d="M5.354 5.119 7.538.792A.516.516 0 0 1 8 .5c.183 0 .366.097.465.292l2.184 4.327 4.898.696A.537.537 0 0 1 16 6.32a.548.548 0 0 1-.17.445l-3.523 3.356.83 4.73c.078.443-.36.79-.746.592L8 13.187l-4.389 2.256a.52.52 0 0 1-.146.05c-.342.06-.668-.254-.6-.642l.83-4.73L.173 6.765a.55.55 0 0 1-.172-.403.58.58 0 0 1 .085-.302.513.513 0 0 1 .37-.245l4.898-.696zM8 12.027a.5.5 0 0 1 .232.056l3.686 1.894-.694-3.957a.565.565 0 0 1 .162-.505l2.907-2.77-4.052-.576a.525.525 0 0 1-.393-.288L8.001 2.223 8 2.226v9.8z"/>
        ...
        <div class="d-flex justify-content-start align-items-center border-top border-secondary pt-3">
          <img src="{{ asset('assets/img/webp/person13.webp') }}" width="96" height="96" class="rounded-circle me-3" alt="a nice person" data-aos="fade" loading="lazy">
          <div>
            <span class="h6 fw-5">Jane Doemunsky</span><br>
            <small class="text-secondary">COO, The Boo Corp.</small>
          </div>
  ...
  <path d="M3.612 15.443c-.386.198-.824-.149-.746-.592l.83-4.73L.173 6.765c-.329-.314-.158-.888.283-.95l4.898-.696L7.538.792c.197-.39.73-.39.927 0l2.184 4.327 4.898.696c.441.062.612.636.282.95l-3.522 3.356.83 4.73c.078.443-.36.79-.746.592L8 13.187l-4.389 2.256z"/>
        ...
        <div class="d-flex justify-content-start align-items-center border-top pt-3">
          <img src="{{ asset('assets/img/webp/person16.webp') }}" width="96" height="96" class="rounded-circle me-3" alt="a nice person" data-aos="fade" loading="lazy">
          <div>
            <span class="h6 fw-5">Jane Doemunsky</span><br>
