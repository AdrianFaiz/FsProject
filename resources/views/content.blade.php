...
@font-face {
  ...
  font-display: swap;
  src: local(''),
       url('{{ asset('assets/fonts/inter-v12-latin-300.woff2') }}') format('woff2'), /* Chrome 26+, Opera 23+, Firefox 39+ */
       url('{{ asset('assets/fonts/inter-v12-latin-300.woff') }}') format('woff'); /* Chrome 6+, Firefox 3.6+, IE 9+, Safari 5.1+ */
}
...
@font-face {
  ...
  font-display: swap;
  src: local(''),
       url('{{ asset('assets/fonts/inter-v12-latin-regular.woff2') }}') format('woff2'), /* Chrome 26+, Opera 23+, Firefox 39+ */
       url('{{ asset('assets/fonts/inter-v12-latin-regular.woff') }}') format('woff'); /* Chrome 6+, Firefox 3.6+, IE 9+, Safari 5.1+ */
}
...
<li class="nav-item">
  ...
  <div class="row d-flex justify-content-center py-vh-5 pb-0">
    ...
    <div class="row">
      ...
      <img src="{{ asset('assets/img/webp/abstract18.webp') }}" width="1446" height="982" alt="abstract image" class="img-fluid position-relative rounded-5 shadow" data-aos="zoom-up">
    </div>
    </div>
        <div class="col-12 col-lg-10 col-xl-8">
